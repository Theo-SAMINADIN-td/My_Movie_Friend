...
def prepare_csv(path : str):
    ...
    movie_dataframe['production_companies'] = movie_dataframe['production_companies'].fillna("[]")
    movie_dataframe['production_countries'] = movie_dataframe['production_countries'].fillna("[]")
...
def main():
    ...
    documents, embeddings, metadatas = chunking_embedding_dataframe(movie_dataframe, embedder)
    ...
    results = retrieve(question="Insterstellar", embedder=embedder, collection=collection )
    print(results)
